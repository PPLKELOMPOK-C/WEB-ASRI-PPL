...
use App\Http\Controllers\CalonPenghuni\JadwalSurveiController;
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Manajemen Dokumen
    Route::resource('dokumen', DokumenController::class)->only(['index','show']);
    ...
    // Jadwal Survei (Sudah diperbaiki lokasinya)
    ...
    Route::post('/berita/{id}/toggle-publish', [NewsController::class, 'togglePublish'])->name('berita.toggle-publish');
...
Route::middleware(['auth', 'role:calon_penghuni'])->prefix('calon')->name('calon.')->group(function () {
    ...
    // Jadwal Survei
    Route::get('/jadwal-survei', [JadwalSurveiController::class, 'indexMandiri'])->name('survei.index');
    Route::get('/jadwal-survei/buat/{unit_id}', [JadwalSurveiController::class, 'buat'])->name('survei.buat');
    Route::post('/jadwal-survei/simpan', [JadwalSurveiController::class, 'simpanMandiri'])->name('survei.simpan');
});
